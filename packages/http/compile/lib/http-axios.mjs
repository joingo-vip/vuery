 ...
 */
export class AxiosChainBuilder extends HttpChainBuilder {
    /**
 ...
 */
export function useAxiosChain(options) {
    if (options.build) {
        return new AxiosChainBuilder(options);
    }
    else {
        return new AxiosChainBuilder(new HttpAxiosClient(options).requestAsync);
    }
}
