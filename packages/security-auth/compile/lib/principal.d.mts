import { ClaimsIdentity, Identity, type Claims } from './identity.mjs';
/**
 * 提供了身份摘要信息相关的基本方法。
 * @author Wang Yucai
 *
 ...
 * @typedef {Principal}
 */
export declare abstract class Principal {
    /**
     * 当前的用户身份信息。
     * @author Wang Yucai
     * @remarks
 ...
 * @extends {Principal}
 */
export declare class AnonymousPrincipal extends Principal {
    /**
 ...
 * @extends {Principal}
 */
export declare class ClaimsPrincipal extends Principal {
    /**
